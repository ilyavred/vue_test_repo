<template>
  <div class="deal-thumb" :data-status="createLabel(deal)" :data-deal_id="deal.id">
    <div class="deal-thumb__base">
      <div class="deal-thumb__base__status">
        <div class="deal-thumb__base__status__marker">
          {{ state_labels[status] }}
        </div>
        <div class="deal-thumb__base__status__top" v-if="deal.in_top">
...
<path d="M16 6.5L18.29 8.79L13.41 13.67L9.41 9.67L2 17.09L3.41 18.5L9.41 12.5L13.41 16.5L19.71 10.21L22 12.5V6.5H16Z"/>
      ...
      <div v-if="(status  != 'pending')" class="button show-more">
...
export default {
  props: {
    deal: {
      ...
      //     in_top:true,
      //     published_date:'December 12, 2020 00:00:00 GMT+06:00',
      //     duration:30,
      //     activation_lag:30,
      //     statistic_summary: {
      //       viewed:12543,
  ...
  data: function() {
    return {
      ...
      //     in_top:true,
      //     published_date:'January 12, 2021 00:00:00 GMT+06:00',
      //     duration:30,
      //     activation_lag:30,
      //     statistic_summary: {
      //       viewed:12543,
  ...
  computed: {
    // onSales: function() {
    //   var now = Date.now()
    //   var publ = new Date(props.deal.published_date).getTime()
    //   this.onsales = Math.floor((now - publ)/1000/60/60/24)
    // }
  },
